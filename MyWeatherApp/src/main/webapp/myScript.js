	...
	const val = document.getElementById("wc").value;
	  switch (val) {
      case 'Clouds':
  ...
  window.addEventListener("DOMContentLoaded", function () {
      ...
      if (condition && icons[condition]) {
          weatherIcon.src = icons[condition];
		  console.log("hello");
      } else {
          weatherIcon.src = "https://cdn-icons-png.flaticon.com/512/1163/1163661.png"; // Default icon
      }
