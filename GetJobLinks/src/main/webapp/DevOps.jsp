...
<body>
    ...
    <div class="container">
        <div class="header">
            <h1>DevOps/SRE Jobs</h1>
            <p>Find your next career opportunity in DevOps/SRE</p>
        </div>
        ...
        <div class="job-listings">
            ...
            <div class="job-card">
                ...
                <h2>DevOps Engineer - Azure DevOps</h2>
                <div class="company-name">Siemens</div>
                
                <div class="job-details">
                    <div class="detail-item">
                        <span class="detail-label">YoE:</span>
                        <span class="detail-value" id="experience-1">4+ years</span>
                    </div>
                    <div class="detail-item">
                        <span class="detail-label">Posted:</span>
                        <span class="detail-value" id="posted-1">1 days ago</span>
                    </div>
                    <div class="detail-item">
                ...
                <a href="https://www.naukri.com/job-listings-devops-engineer-azure-devops-siemens-limited-bengaluru-4-to-9-years-301025925828?src=seo_srp&sid=17619208238798982&xp=1&px=1">
                <button class="apply-btn" onclick="applyForJob(1)">Apply Now</button></a>
            </div>
            ...
            <!-- job 2 -->
               <div class="job-card">
                ...
                <h2>DevOps Engineer - L3</h2>
                <div class="company-name">Wipro</div>
                
                <div class="job-details">
                    <div class="detail-item">
                        <span class="detail-label">YoE:</span>
                        <span class="detail-value" id="experience-1">3 - 4 years</span>
                    </div>
                    <div class="detail-item">
                        <span class="detail-label">Posted:</span>
                        <span class="detail-value" id="posted-1">1 days ago</span>
                ...
                <a href="https://www.naukri.com/job-listings-devops-engineer-l3-wipro-limited-bengaluru-3-to-5-years-301025923348?src=seo_srp&sid=17619208238798982&xp=2&px=1">
                <button class="apply-btn" onclick="applyForJob(1)">Apply Now</button></a>
            </div>
    <!-- Footer -->
    <footer>
